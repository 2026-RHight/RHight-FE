<template>
  <div class="performance-content">
    ...
    <TeamEvaluation v-else-if="perfStore.activePage === 'team-evaluation'" />
    ...
    <TeamStats v-else-if="perfStore.activePage === 'team-stats'" />
  </div>
</template>
...
import TeamEvaluation from './TeamEvaluation.vue'
