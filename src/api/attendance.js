...
export const getMyBusinessTripRequests = (params) =>
  api.get('/business-trips/my-requests', { params })
...
export const getWeeklyWorkScheduleStatusCounts = () =>
  api.get('/attendance/weekly/status-counts')

export const cancelWeeklyWorkSchedule = (weeklyId) =>
  api.put(`/attendance/weekly/${weeklyId}/cancel`)

export const getTeamWeeklyWorkSchedules = (params) =>
  api.get('/attendance/weekly/team', { params })

export const processWeeklyWorkSchedule = (payload) =>
  api.put('/attendance/weekly/process', payload)
